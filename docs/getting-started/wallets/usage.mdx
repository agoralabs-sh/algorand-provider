...
Next, a wallet manager will need to be created, conforming to the [`BaseWalletManager`](../../api-reference/base-wallet-manager) class. The manager can then be added to the `window.algorand` provider:
